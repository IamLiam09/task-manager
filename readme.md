...
Fullscreen
etc.
The Task Management System was developed using HTML, PHP/MySQLi(database), CSS, JavaScript (jQuery/Ajax), and Bootstrap for the design.
...
Open a web browser and browse the project. E.g [http://localhost/task-manager2.0]<br>
Admin Access<br>
